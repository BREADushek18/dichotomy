...
namespace dichotomy
{
    public partial class SLAU : Form
    {
        ...
        private void вернутьсяНазадToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            this.Close();
            mainForm.Show();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < n; i++) // по всем строкам
            {
                ...
                dataGridViewA.Columns[i].HeaderCell.Value = $"X{i + 1}";
                dataGridViewA.Rows[i].HeaderCell.Value = (i + 1).ToString();
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < n; i++) // по всем строкам
            {
                ...
                dataGridViewB.Columns[0].HeaderCell.Value = "Y";
            }
        }
        ...
        private void SLAU_Load(object sender, EventArgs e)
        {
